	...
	public static function inputSchema(): array {
		...
		return array(
			...
			'properties'           => array(
				...
				'content_id_platform'          => array( 'type' => 'string', 'description' => 'Scope the content_id / variable_as_simple / wpml_unified_id args to ONE active platform slug (e.g. `facebook`, `gatags`, `pinterest`, `bing`, `reddit`). Omit to write to every active content-id platform. Read current per-platform values from get_woo_events_config `content_id_by_platform`.' ),
